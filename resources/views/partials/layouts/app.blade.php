...
<body class="bg-slate-200 min-h-screen flex flex-col">
    ...
    <header id="header" class="bg-white">
        ...
        <nav class="relative px-4 py-2 flex justify-around items-center bg-white">
            ...
            <div class="hidden lg:flex">
                ...
                <button id="theme-toggle" type="button"
                    class="hidden lg:inline-block lg:ml-auto py-1.5 px-3 m-1 text-center bg-gray-100 border border-gray-300 rounded-md text-black  hover:bg-gray-100 hover:bg-gray-100">
